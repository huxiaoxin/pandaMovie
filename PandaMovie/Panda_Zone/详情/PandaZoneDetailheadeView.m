...
-(instancetype)initWithFrame:(CGRect)frame ConfigZoneModel:(PandaZoneModel *)zoneModel{
    if (self = [super initWithFrame:frame]) {
        ...
        UIView * PandaZoneContenView = [[UIView alloc]initWithFrame:CGRectMake(RealWidth(15), K(10), SCREEN_Width-RealWidth(30), K(40))];
        PandaZoneContenView.backgroundColor = [UIColor colorWithHexString:@"292945"];
        PandaZoneContenView.userInteractionEnabled = YES;
        PandaZoneContenView.layer.cornerRadius = RealWidth(5);
        PandaZoneContenView.layer.masksToBounds = YES;
        ...
        PandaZoneContenTitle.textColor = [UIColor whiteColor];
        ...
        PandaZoneContenTimelb.textColor = [UIColor whiteColor];
        ...
        UIButton * PandaZonelaheiBtn = [[UIButton alloc]initWithFrame:CGRectMake(SCREEN_Width-K(65+30), CGRectGetMidY(PandaZoneContenImgView.frame)-K(10), K(50), K(20))];
        ...
        PandaZoneDesclb.textColor = [UIColor whiteColor];
        ...
        PandaZoneDesclb.size =  [PandaZoneDesclb getSpaceLabelSize:zoneModel.content withFont:[UIFont systemFontOfSize:12] withWidth:SCREEN_Width-K(30+30) lineSpacing:K(3)];
        ...
        SDCycleScrollView  *  PandaZoneSDCView = [[SDCycleScrollView alloc]initWithFrame:CGRectMake(K(15), CGRectGetMaxY(PandaZoneDesclb.frame)+K(8), SCREEN_Width-K(60), K(180))];
        ...
        PandaZoneContenView.height = CGRectGetMaxY(PandaZoneSDCView.frame)+K(10);
