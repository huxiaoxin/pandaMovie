...
@interface PandaHotNewsDetailController ()<WKNavigationDelegate>
@property(nonatomic,strong) WKWebView * web;
@property(nonatomic,strong) UIActivityIndicatorView * activityIndicator;
@end

@implementation PandaHotNewsDetailController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.gk_navTitle = _pandaitem.title;
    
    NSString *html2 = [NSString stringWithFormat:@"<html><head><style>div{font-size:20px;}img{width: 100%%;height: auto;</style></head><body>%@</body></html>",self.pandaitem.content];
